...
class Tickets(db.Model):
    ...
    incident_title = db.Column(db.String(50), nullable=False)
    ...
    reported_by = db.Column(db.String(10), nullable=False)
    ...
    resolution_code = db.Column(db.String(10), nullable=True)
